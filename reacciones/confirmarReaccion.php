...
$email_cliente_victima = $fila["email"];
$direccion_cliente_victima = $fila["direccion_usuario_cliente"];
...
if ($fila["foto_perfil_usuario_cliente"]) {
    $foto_perfil = $fila["foto_perfil_usuario_cliente"];
} else {
    $foto_perfil = "";
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['btn'])) {
    ...
    $sentencia_0 = "UPDATE reacciones_cliente_cliente SET confirmacionReaccion= 1 WHERE id_reaccion_cliente_cliente = $id_reaccion";
    ...
    <main class="main">
        ...
        <section class="content">
            ...
            <article class="enlace">
                <h3 class="titulo_servicio">Hola! <?php echo $nombre_usuario_cliente_reaccion ?></h3>
                <div class="info_alerta">
                    ...
                    <div class="info_usuario">
                        <table>
                            <tr>
                                <th>Nombres:</th>
                                <td><?php echo $nombre_cliente_victima ?></td>
                            </tr>
                            <tr>
                                <th>Apellidos:</th>
                                <td><?php echo $apellido_cliente_victima ?></td>
                            </tr>
                            <tr>
                                <th>Teléfono:</th>
                                <td><?php echo $telefono_cliente_victima ?></td>
                            </tr>
                            <tr>
                                <th>Correo</th>
                                <td><?php echo $email_cliente_victima ?></td>
                            </tr>
                            <tr>
                                <th>Dirección:</th>
                                <td><?php echo $direccion_cliente_victima ?></td>
                            </tr>
                        </table>
                    </div>
